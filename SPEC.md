...
2. A user can create or restart their own game session.
3. A user can submit supported game commands through Telegram messages and/or inline buttons.
4. A user receives a readable game response after each command.
5. Different Telegram users have isolated game states.
